...
class game_view():
    ...
    def __init__(self, box_size = 0.85, speed = 0.1, mimimum_distance_between = 0.33, FPS = 60, TPS = 60):
        ...
        logo = pygame.image.load("maffay.png")
        ...
        self.right = (self.__screen.get_width() * 0.67 + 1) * 0.5
    ...
    def main_loop(self):
        ...
        #TODO turn this into a thread or MUltprocessing
        running = True
    ...
    def __check_for_prediction(self):
        if self.__event_queue.empty():
            ...
            if pred == circle.x:
                circle.colour = (0,255,0)
                circle.redundant = True
